...
public class QuestionController {
  ...
  public ResponseEntity<QuestionEditResponse> editQuestion(
    ...
    final UserAuthTokenEntity userAuthTokenEntity =
        questionService.authenticate(authorization, questionId);
  ...
  public ResponseEntity<QuestionDeleteResponse> deleteQuestion(
    ...
    QuestionDeleteResponse questionDeleteResponse =
        new QuestionDeleteResponse().id(questionEntity.getUuid()).status("QUESTION DELETED");
  ...
  public ResponseEntity<List<QuestionDetailsResponse>> getQuestionsByUser(
    ...
    List<QuestionEntity> questionEntities =
        questionService.getAllQuestionByUser(authorization, userId);
    List<QuestionDetailsResponse> questionDetailsResponseList = new ArrayList<>();
